...
const ContentReviewDetails = ({ isOpen, onClose, contentItem }) => {
        ...
        <div className="flex items-center mt-12 justify-between p-6 ">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Flagged for review on August 15, 2025 at 2:30 PM
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 p-6 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <p className="font-medium text-gray-900">Arif Hassan</p>
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <p className="font-medium text-gray-900">Joti Das</p>
                    <button className="text-sm flex items-center gap-1">
                      View Profile <FaArrowRight className="text-[11px]" />
                    </button>
                  </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <button className="text-sm flex items-center gap-1">
                      View Job Details <FaArrowRight className="text-[11px]" />
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="bg-red-100  rounded-lg px-1">
                  <span className="text-red-600 font-medium text-sm">
                    Offensive Language & Personal Attack
                  </span>
                </div>
              </div>{" "}
              {/* Reporter */}
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">*No record</p>
              </div>
            </div>
          </div>
