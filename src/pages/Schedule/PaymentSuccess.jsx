...
export const PaymentSuccess = () => {
  ...
  useEffect(() => {
    ...
    // Assuming the appointmentId is passed as a query parameter named 'appointmentId'
    setAppointmentId(params.get("appointmentId"));
  }, [location.search]);

  console.log("Appointment ID:", appointmentId);

  // You might want to fetch full appointment details here using the appointmentId
  return (
